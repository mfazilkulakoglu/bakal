...
public class ShowOrderDetail: UIView, UITableViewDelegate, UITableViewDataSource {
    ...
    func showAlert(with model: GivenOrder, on viewController: UIViewController) {
        ...
        tableView.frame = CGRect(x: 5,
                                 y: statuLabel.bottom + 10,
                                 width: detailView.width - 10,
                                 height: commentLabel.top - statuLabel.bottom - 20)
        ...
        DispatchQueue.main.async { [self] in
            ...
            detailView.addSubview(statuLabel)
            ...
            if self.model!.orderInfo.statu == "On the Way" {
                statuLabel.text = "On the Way"
                statuLabel.backgroundColor = .systemOrange
            } else if self.model!.orderInfo.statu == "Delivered" {
                statuLabel.text = "Delivered"
                statuLabel.backgroundColor = .systemRed
            } else {
                statuLabel.text = "Preparing"
                statuLabel.backgroundColor = .systemGreen
            }
